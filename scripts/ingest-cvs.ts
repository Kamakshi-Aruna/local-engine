...
async function main() {
  console.log('🚀 Starting CV ingestion to Qdrant...\n');
  ...
  console.log(`\n🎉 Ingestion complete!`);
  console.log(`\nYou can now test searches like:`);
  console.log(`   - "Show me top 5 mobile developers"`);
  console.log(`   - "Find iOS specialists"`);
  console.log(`   - "Backend developers with API experience"`);
}
